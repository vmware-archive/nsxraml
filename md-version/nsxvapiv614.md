# VMware NSX for vSphere API documentation version 6.1.4
...
* **post** *(secured)*: Create a new Transport Zone
...
* **put** *(secured)*: Updates a transport zone, you can add a cluster to or delete a cluster from a transport zone
